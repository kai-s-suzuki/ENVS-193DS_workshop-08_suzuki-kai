...
drought_exp_clean <- drought_exp |> # starting w/ the drought_Exp object
...
ggplot(data = drought_exp_clean,
  ...
  labs(x = "Water treatment",
       y = "Total mass (g)",
       title = "Mean plant mass is higher in well watered than drought stressed treatment") +
  # taking out legend
...
ggplot(data = drought_exp_clean,
  ...
  labs(x = "Species",
       y = "Total mass (g)",
       title = "Species differ in mean total mass (g)") +
...
The best model that explains total plant mass includes water_treatment and species_name (F(7, 62) = 27.08, p < 0.001, $\alpha$ = 0.05), but not SLA. 
